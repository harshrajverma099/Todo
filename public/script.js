async function verification(){
    ...
    const response = await axios.post("https://todo-ten-jade.vercel.app/verification",{
        email: signUpEmail
    })
...
async function verifyOTP(){
    ...
    const response = await axios.post("https://todo-ten-jade.vercel.app/otp",{
        otp: otp,
...
async function signUp(){
    ...
    const response = await axios.post("https://todo-ten-jade.vercel.app/signUp",{
        password: password,
...
async function signIn(){
    ...
    const response = await axios.post("https://todo-ten-jade.vercel.app/signIn",{
        email: email,
        password: password
    })
